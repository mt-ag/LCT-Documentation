...
Static Ids defined in the APEX App Builder will replace the autogenereated ids and make it easier to create stable selectors.
See a an example for a button below:
